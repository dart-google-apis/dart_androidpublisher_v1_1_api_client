part of androidpublisher_v1_1_api_console;

/** Client to access the androidpublisher v1.1 API */
/** Lets Android application developers access their Google Play accounts. */
class Androidpublisher extends ConsoleClient {

  InapppurchasesResource_ _inapppurchases;
  InapppurchasesResource_ get inapppurchases => _inapppurchases;
  ...
  Androidpublisher([oauth2.OAuth2Console auth]) : super(auth) {
    ...
    _inapppurchases = new InapppurchasesResource_(this);
